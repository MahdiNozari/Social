...
class PostDetailView(View):
    ...
    def get(self,request,post_id,post_slug):
        ...
        if request.user.is_authenticated and self.post_instance.can_like(request.user):
            can=True
        return render(request,'home/detail.html',{'post':self.post_instance,'comments':comments,'form':self.form_class,'reply_form':self.form_class_reply,'can':can})
...
class PostLikeView(LoginRequiredMixin,View):
    def get(self,request,post_id):
        ...
        if like.exists():
            messages.error(request,'you aleardy liked this post','danger')
        else:
